...
class JGenerateFrame extends Frame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		try{ FileReader f1 = new FileReader("jques.txt");
		...
		FileReader f1 = new FileReader("jques.txt");
		BufferedReader reader = new BufferedReader(f1);
		String curline;
		...
		for(i = 0;i<j;i++)
		{
			...
			while((curline = reader.readLine()) != null) {
				...
				reader.close();
				f1 = new FileReader("jques.txt"); //Have to do this to read the file from the beginning again
		...
		FileReader f1 = new FileReader("jans.txt");
		BufferedReader reader = new BufferedReader(f1);
		String curline;
		...
		for(i = 0;i<j;i++)
		{
			...
			while((curline = reader.readLine()) != null) {
				...
				writer.write(edit + System.getProperty("line.separator"));
				reader.close();
				f1 = new FileReader("jans.txt"); //Have to do this to read the file from the beginning again
				reader = new BufferedReader(f1);
				break;
				}				
			}
